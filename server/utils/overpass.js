  ...
  try {
    ...
    return data.elements
      ...
      .map((e) => ({
        ...
        dietary: {
          vegan: e.tags["diet:vegan"] || "unknown",
          vegetarian: e.tags["diet:vegetarian"] || "unknown",
          gluten_free: e.tags["diet:gluten_free"] || "unknown",
        },
        price:
          e.tags.price_level || Math.random() > 0.6
            ? "$$$"
            : Math.random() > 0.3
              ? "$$"
    ...
    return [
      {
        ...
        cuisine: "Italian",
        dietary: { vegan: "no", vegetarian: "yes", gluten_free: "yes" },
        price: "$$$",
        lat: lat + 0.001,
        lon: lng + 0.001,
        rating: 4.8,
      ...
      },
      {
        ...
        name: "Sushi Zen",
        cuisine: "Sushi",
        dietary: { vegan: "yes", vegetarian: "yes", gluten_free: "yes" },
        price: "$$",
        lat: lat - 0.001,
        lon: lng - 0.001,
        rating: 4.5,
      ...
      },
      {
        ...
        name: "Burger King",
        cuisine: "Burgers",
        dietary: { vegan: "no", vegetarian: "no", gluten_free: "no" },
        price: "$",
        lat: lat + 0.002,
        lon: lng - 0.002,
        rating: 3.9,
